...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send()
            # messages.success(request, 'Thank you for registering with us. We have sent verification email to your email address. Please verify it.')
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    # get the cart items from the user to be incooperated in product variation
                    ...
                    for pv in product_variation:
                        if pv in ex_var_list:
                            ...
                            # current variation from product variation
                            # card_id from database
